...
set yrange [ 0.00000 : 100.00 ] noreverse nowriteback
...
set term svg
set output 'runningRes_480.svg'
set title 'Running Jobs Tue, 09 Aug 2016 11:23:37 -0400'
plot '../runningJobs/fixed_CADES_JOBS_480' using ($1+$5/2):3:5:($8+.25):cbtic(7) every ::2 with boxes palette title ''
